...
import 'package:holy_quran/models/ayat.dart';
import 'package:holy_quran/models/surah.dart';

class DetailScreen extends StatelessWidget {
  final int noSurat;
  final String searchKeyword;

  const DetailScreen({Key? key, required this.noSurat, required this.searchKeyword});
